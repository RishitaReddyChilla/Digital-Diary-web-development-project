...
if ($result->num_rows > 0) {
  echo "<table><tr><th>USERNAME</th>&nbsp&nbsp<th>DATE</th><th>DIARY</th></tr>";
  // output data of each row
  while($row = $result->fetch_assoc()) {
    echo "<tr><td>&nbsp&nbsp".$row["username"]."</td>&nbsp&nbsp&nbsp<td>".$row["Date"]."</td><td>&nbsp&nbsp&nbsp&nbsp".$row["Diary"]."</td></tr>";
  }
  echo "</table>";
} else {
  echo "0 results";
